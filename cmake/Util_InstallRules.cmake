...
set(
    "FILESYSTEM_INSTALL_CMAKEDIR" "${CMAKE_INSTALL_LIBDIR}/cmake/${package}"
    CACHE STRING "CMake package config location relative to the install prefix"
)

set_property(CACHE "FILESYSTEM_INSTALL_CMAKEDIR" PROPERTY TYPE PATH)
mark_as_advanced("FILESYSTEM_INSTALL_CMAKEDIR")

install(
    EXPORT filesystemTargets
    FILE filesystemTargets.cmake
...
if(MSVC)
    ...
    if(BUILD_SHARED_LIBS)
        set(pdb_file "$<TARGET_PDB_FILE:filesystem>")
        set(pdb_file_destination "${CMAKE_INSTALL_BINDIR}")
    else()
        set(pdb_file "$<TARGET_FILE_DIR:filesystem>/$<TARGET_FILE_PREFIX:filesystem>$<TARGET_FILE_BASE_NAME:filesystem>.pdb")
