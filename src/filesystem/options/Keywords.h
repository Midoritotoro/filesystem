...
struct checked_keyword: as_keyword<checked_keyword<_ID_, _Checker_>> {
    ...
    template <class _Type_> 
    static filesystem_always_inline constexpr bool check() {
...
constexpr flag_keyword() {}
    ...
    constexpr flag_keyword(const id_type&)
    {}
    ...
    template <class _Type_>
    constexpr filesystem_always_inline auto operator=(_Type_&&) const noexcept {
        return *this; 
    }
    ...
    constexpr filesystem_always_inline decltype(auto) operator()(_Option0_&&, _Option1_&&, _Options_&& ...) const {
