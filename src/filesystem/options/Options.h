...
struct options: _Settings_ {
    ...
    constexpr filesystem_always_inline explicit options(_Options_ && ... __options) noexcept:
        _Settings_(std::forward<_Options_>(__options) ...) 
    {}

    template <class ... _Options_>
    constexpr filesystem_always_inline explicit options(const settings<_Options_...>& __options) noexcept :
...
template <concepts::option ... _Options_>
options(_Options_&& ... __options) -> options<decltype(settings(std::forward<_Options_>(__options) ...))>;
