...
struct strict_elementwise_callable: conditional_callable<_Function_, _OptionsValues_, _Options_...> {
    ...
    constexpr filesystem_always_inline auto adapt_call(const __Options_& __options, 
